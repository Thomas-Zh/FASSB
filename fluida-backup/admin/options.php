...
'sections' => array(
	...
	array('id'=>'fluida_lpboxes1', 'title'=>__('Units Boxes','fluida'), 'callback'=>'', 'sid'=>'fluida_landingpage', 'priority' => 40),
	array('id'=>'fluida_lpboxes2', 'title'=>__('Projects Boxes','fluida'), 'callback'=>'', 'sid'=>'fluida_landingpage', 'priority' => 50),
...
'options' => array (
	...
	'id' => 'fluida_lptextone',
		'type' => 'select',
		'label' => sprintf( __('Our mission','fluida'), 1),
