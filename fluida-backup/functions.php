...
require_once( get_template_directory() . "/functionality/our_projects/plugin.php");
require_once( get_template_directory() . "/functionality/our_units/plugin.php");
require_once( get_template_directory() . "/functionality/our_systems/plugin.php");
// Frontend side
