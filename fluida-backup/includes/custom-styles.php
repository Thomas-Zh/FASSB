...
#footer a, .page-title strong 				{ color: #F1F1F1; }
#footer a:hover, #site-title a:hover span 	{ color: #fba643; }
...
.lp-boxes-3.lp-box .lp-box-image { height: <?php echo intval ( (int) $fluida_lpboxheight3 ); ?>px; }
.lp-boxes-3.lp-boxes-animated .lp-box:hover .lp-box-text { max-height: <?php echo intval ( (int) $fluida_lpboxheight3 - 100 ); ?>px; }
