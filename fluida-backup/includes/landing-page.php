...
function recent_news(){
	?><div class="recent-news-title" style="margin-left:10vw; background-color:transparent;"><h1>Recent news</h1></div><?php
}
endif;
if ( ! function_exists( 'new_to_fassb()' ) ):
function new_to_fassb(){
	?><div class="new_to_fassb" style="background-color:transparent;display:flex;flex-direction:row;justify-content:center;">
		<div class="new_text" style="margin-top:10vw;margin-bottom:8vw">
			<p style="font-size:3em;">New to FASSB?</p>
		</div>
		<div class="new_button">
		<a class="staticslider-button" style="background-color:#FBA643;margin-top:10vw;margin-bottom:7vw;margin-left:3vw;" href="https://www.google.com">Start here!</a>
		</div>
	</div><?php
}
endif;
...
function fluida_lpslider_output( $data ){
	...
	<section class="lp-staticslider">
		...
		<?php } ?>
		<div class="staticslider-content" style="display:flex;flex-direction:row;justify-content:center">
			<div class="staticslider-caption"style="left:2%;">
				<img src="http://142.144.0.11/wp-content/uploads/2019/02/logo1.png" style="width:20%;margin-left:auto; margin-right:auto;padding:10px;">
			</div>

			<div class="staticslider-caption">
			<?php if ( ! empty( $content ) )	{ ?><span class="staticslider-sep"></span><?php } ?>
				...
				<div class="staticslider-caption-buttons" >
					<?php if ( ! empty( $lpslidercta1text ) ) { echo '<a class="staticslider-button" style="background-color:#FBA643;float: right;
    margin-top: -7%; margin-right:10%;" href="' . esc_url( $lpslidercta1link ) . '">' . esc_html( $lpslidercta1text ) . '</a>'; } ?>
	...
	extract($data); ?>
			<div class="lp-box box<?php echo absint( $colno ); ?> ">
					<div class="lp-box-image lpbox-rnd<?php echo $randomness[$colno%8]; ?>">
						...
						<a href="<?php echo esc_url( $link ); ?>"><!--wrap lp-box-overlay with link-->
					...
					<div class="lp-box-content">
						<?php if ( ! empty( $title ) ) { ?><h5 class="lp-box-title">
							<?php if ( !empty( $readmore ) && !empty( $link ) ) { ?> <a href="<?php echo esc_url( $link ); ?>" <?php echo esc_attr( $target ); ?>><?php } ?>
								<a href="<?php echo esc_url( $link ); ?>"><?php echo do_shortcode( $title ); ?></a>
